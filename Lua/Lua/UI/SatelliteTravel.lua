...
local lGetSectorTerrainTypeUI = function(sector, waypoint, routeIdx, prevSector)
...
local lGetBreakdownHasSpecialTerrainModifier = function(travelBreakdown)
...
local lAddWaterTravelCostToRouteBreakdown = function(waterTravelTiles, waterTravelCost, breakdown)
  ...
  for w = 1, #route do
    ...
    for i = 1, #waypoint do
      ...
      if terrainChanged then
        ...
        currentSection.dest = sId
        if travelBreakdown and 0 < #travelBreakdown then
