...
function ShowTrainMilitiaTutorial()
  ...
  if not (not IsConflictMode(gv_CurrentSectorId) and gv_CurrentSectorId == "H2" and g_CurrentSquad and gv_Squads[g_CurrentSquad]) or gv_Squads[g_CurrentSquad].Retreat then
    return
  end
