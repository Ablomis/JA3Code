...
function WallInvisibilityThreadMethod_V2_PlanA()
  ...
  local lastCamPos, lastLookAt, lastHideAll, lastIsInOverview, lastIsInCombat, lastFloor, lastVisibilityMode, last_update_time
  ...
  while true do
    ...
    if not last_update_time or not (now() < last_update_time + 500) then
