...
function SetpiecePrgs.GraveyardChickenMove2(seed, state, TriggerUnits)
  local li = {
  ...
  prgdbg(li, 1, 3)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "GraveyardChickenMove2_Schliemann", nil)
  prgdbg(li, 1, 4)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "GraveyardChickenMove2_Veinard", nil)
end
