...
function SetpiecePrgs.ChickenMove2(seed, state, TriggerUnits)
  local li = {
    id = "ChickenMove2"
  }
  ...
  prgdbg(li, 1, 3)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "ChickenMove2_Schliemann", nil)
  prgdbg(li, 1, 4)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "ChickenMove2_Veinard", nil)
end
