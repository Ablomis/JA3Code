...
function SetpiecePrgs.ArcheologicalChickenMove3(seed, state, TriggerUnits)
  local li = {
  ...
  prgdbg(li, 1, 3)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "ArcheologicalChickenMove3_Schliemann", nil)
  prgdbg(li, 1, 4)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "ArcheologicalChickenMove3_Veinard", nil)
end
