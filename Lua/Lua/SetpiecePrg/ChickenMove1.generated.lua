...
function SetpiecePrgs.ChickenMove1(seed, state, TriggerUnits)
  local li = {
    id = "ChickenMove1"
  }
  ...
  prgdbg(li, 1, 3)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "ChickenMove1_Schliemann", nil)
  prgdbg(li, 1, 4)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, false, "", "", "ChickenMove1_Veinard", nil)
end
