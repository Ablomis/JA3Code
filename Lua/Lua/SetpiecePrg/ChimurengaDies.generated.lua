...
function SetpiecePrgs.ChimurengaDies(seed, state, TriggerUnits)
  local li = {
    id = "ChimurengaDies"
  }
  ...
  prgdbg(li, 1, 5)
  sprocall(PrgPlaySetpiece.Exec, PrgPlaySetpiece, state, rand, true, "", "", "ConversationKill_SubPiece", Merc, Chimurenga)
end
