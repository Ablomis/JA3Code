...
You will lose all changes made. Continue?]]), Untranslated("Yes"), Untranslated("No")) ~= "ok" then
  ...
  PlaceObj("XTemplateAction", {
    ...
    PlaceObj("XTemplateAction", {
      ...
      "Shows All Debug Covers",
      "RolloverText",
      "Shows All Debug Covers(No Rebuild)",
      "ActionId",
      "ShowDebugCoversNoRebuild",
      "ActionSortKey",
      "1735",
      "ActionTranslate",
      false,
      "ActionName",
      "Show Debug Covers(no Rebuild)",
      "ActionIcon",
      "CommonAssets/UI/Icons/starburst.png",
      "OnAction",
      function(self, host, source, ...)
  ...
  PlaceObj("XTemplateAction", {
    ...
    PlaceObj("XTemplateAction", {
      "comment",
      "NOT IMPLEMENTED; Added so DiplayName can go into loc",
      "ActionId",
      "groupMove",
      "ActionSortKey",
      "2069",
      "ActionName",
      T(757832582030, "Move squad"),
      "ActionBindable",
      true,
      "ActionMouseBindable",
      false
    ...
    PlaceObj("XTemplateAction", {
      ...
      "__condition",
      function(parent, context)
        return not Platform.steamdeck and not Platform.demo
      end,
      "replace_matching_id",
      true
    }),
    ...
    PlaceObj("XTemplateAction", {
      ...
      "__condition",
      function(parent, context)
        return Platform.developer or Platform.cheats or Platform.trailer or IsInModTestingMode()
      end,
      "replace_matching_id",
      true
    }),
  ...
  PlaceObj("XTemplateAction", {
    ...
    "__condition",
    function(parent, context)
      return not Platform.developer and not IsInModTestingMode()
    end
  }),
  PlaceObj("XTemplateAction", {
    "comment",
    ...
    PlaceObj("XTemplateAction", {
      ...
      function(self, host, source, ...)
        ...
        if CampaignPauseReasons.SatelliteConflict then
          ...
          if g_SatelliteUI.rollover_sector then
            g_SatelliteUI:OnSectorRollover(nil, g_SatelliteUI.rollover_sector, false)
          end
