    ...
    PlaceObj("XTemplateWindow", {
      ...
      PlaceObj("XTemplateGroup", {
        ...
        PlaceObj("XTemplateTemplate", {
          ...
          "__condition",
          function(parent, context)
            return InventoryIsContainerOnSameSector(context)
          end,
          "__template",
          "ContextMenuButton",
          "Id",
      ...
      PlaceObj("XTemplateGroup", {
        ...
        PlaceObj("XTemplateGroup", {
          "__condition",
          function(parent, context)
            return context and InventoryIsContainerOnSameSector(context) and context.item and context and context.item:IsKindOfClasses("Medkit", "FirstAidKit")
          end
        }, {
          PlaceObj("XTemplateTemplate", {
            "comment",
      ...
      PlaceObj("XTemplateTemplate", {
        ...
        "__condition",
        function(parent, context)
          return InvContextMenuEquippable(context)
        end,
        "__template",
        "ContextMenuButton",
        "Id",
      ...
      PlaceObj("XTemplateTemplate", {
        ...
        function(self, context, ...)
          ...
          local actionName = T(692159353735, "DROP")
      ...
      PlaceObj("XTemplateTemplate", {
        ...
        "__condition",
        function(parent, context)
          return InvContextMenuFilter(context, "Valuables")
        end,
        "__template",
        "ContextMenuButton",
        "Id",
      ...
      PlaceObj("XTemplateTemplate", {
        ...
        "__condition",
        function(parent, context)
          return InvContextMenuFilter(context, "ValuablesStack")
        end,
        "__template",
        "ContextMenuButton",
        "Id",
      ...
      PlaceObj("XTemplateTemplate", {
        ...
        "__condition",
        function(parent, context)
          return InvContextMenuFilter(context, "ValuableItemContainer")
        end,
        "__template",
        "ContextMenuButton",
        "Id",
