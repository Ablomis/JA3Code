  ...
  PlaceObj("XTemplateWindow", {
    ...
    PlaceObj("XTemplateWindow", {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(657654851208, "<ShortcutName('actionPrevSquad')>/<ShortcutName('actionNextSquad')> Previous/Next Squad"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(472881540356, "<ShortcutName('actionCamOverview')> Overview mode"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(798585288478, "<ShortcutName('actionOpenCharacter')> Character Screen"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(428011132139, "<ShortcutName('idInventory')> Inventory"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(676659458353, "<ShortcutName('actionCamFloorUp')>/<ShortcutName('actionCamFloorDown')> Change floor"),
                "WordWrap",
                false
              })
            }),
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(966322975426, "<ShortcutName('GamepadTargetingNext')> Attack"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(218324926284, "<ShortcutName('GamepadAimTakeCoverOrOverwatch')> Overwatch"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(892577672818, "<ShortcutName('Reload')> Reload"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(247187751629, "<ShortcutName('GamepadChangeWeapons')> Switch Weapon"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(510337751650, "<ShortcutName('GamepadQuickAction')> Hide/Reveal"),
                "WordWrap",
                false
              })
            }),
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(857421871763, "<ShortcutName('GamepadPrevUnit')>/<ShortcutName('GamepadNextUnit')> Select Previous/Next Merc"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(446625422990, "<LeftTrigger>/<RightTrigger> Additional controls"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(574974041680, "<ShortcutName('ExplorationSelectionToggle')> <GamepadSelectToggleDynamicText()>"),
                "WordWrap",
                false
              }, {
                PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(336236068973, "<ShortcutName('GamepadCameraToUnit')> Center camera"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(937203296524, "<ShortcutName('HighlightInteractables')> Highlight interactables"),
                "WordWrap",
                false
              }),
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(967392707679, "<ShortcutName('toggleActivePause')> Active pause"),
                "WordWrap",
                false
              })
            })
        ...
        PlaceObj("XTemplateWindow", {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateForEach", {
              ...
              "array",
              function(parent, context)
                return Selection and Selection[1] and GetTargetsToShowAboveActionBar(Selection[1], GetDialog(parent)) or empty_table
              end,
              "__context",
      ...
      PlaceObj("XTemplateWindow", {
        ...
        true,
        "Text",
        T(344860845336, "WAITING FOR THE OTHER PLAYER")
      }),
      PlaceObj("XTemplateWindow", {
        "comment",
        "gamepad hint",
          ...
          PlaceObj("XTemplateTemplate", {
            ...
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(935267226434, "<ShortcutButton('idRetreatAction')>")
              })
            })
          })
        })
