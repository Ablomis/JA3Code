      ...
      function(self, host)
        ...
        CreateRealTimeThread(function()
          ...
          if has_prev_data and diff then
            local qdlg = CreateQuestionBox(GetDialog("PDADialog"), T(824112417429, "Warning"), T(176326810773, "Do you want to start the operation? If confirmed, the operation will restart with the new parameters. Resources and end time may change based on this"), T(1138, "Yes"), T(1139, "No"))
            qdlg:SetModal()
          ...
          PlaceObj("XTemplateMode", {"mode", "change"}, {
            ...
            PlaceObj("XTemplateAction", {
              ...
              function(self, host, source, ...)
                ...
                function action_bar.OnUpdateActions(this)
                  XActionsView.OnUpdateActions(this)
                  local button = this[1][1]
                  function button.OnLayoutComplete(t)
                    if ctxMenu then
            ...
            function(self, host, source, ...)
              ...
              CreateRealTimeThread(function(args)
                ...
                if args and args[1] then
                  ...
                  local dlg = CreateQuestionBox(GetDialog("PDADialog"), T(824112417429, "Warning"), restore_txt ~= "" and T({
                    653728009504,
                    [[
<warning>
<restore>]],
