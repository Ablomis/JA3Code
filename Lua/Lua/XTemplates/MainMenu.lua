      ...
      PlaceObj("XTemplateWindow", {
        ...
        PlaceObj("XTemplateMode", {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            "__condition",
            function(parent, context)
              return Game and not gv_SatelliteView
            end,
            "__class",
            "XContentTemplate",
            "Margins",
            ...
            PlaceObj("XTemplateWindow", {
              ...
              true,
              "Text",
              T(753225534189, "Tactical view")
            }),
            PlaceObj("XTemplateWindow", {
              "comment",
              "Controller layout - tactical",
              "LayoutMethod",
              "VList"
            }, {
              PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  PlaceObj("XTemplateWindow", {
                    ...
                    true,
                    "Text",
                    T(519456784806, "<LeftTrigger> Additional controls"),
                    "TextHAlign",
                    "right"
                  }),
                  PlaceObj("XTemplateWindow", {
...
<DPadDown> Stance down]])
                    ...
                    PlaceObj("XTemplateWindow", {
                      ...
                      true,
                      "Text",
                      T(572466954049, "<DPadLeft>/<DPadRight> Action bar")
                    })
                  })
                }),
                PlaceObj("XTemplateWindow", {
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  PlaceObj("XTemplateWindow", {
                    ...
                    true,
                    "Text",
                    T(816754689356, "<RightTrigger> Additional controls")
                  }),
                  PlaceObj("XTemplateWindow", {
                    "comment",
                    "RB",
...
<ButtonA>(Hold) Move squad]])
                      ...
                      PlaceObj("XTemplateWindow", {
                        ...
                        true,
                        "Text",
                        T(614069851832, "<ButtonB> Close action bar")
                      })
                    }),
                    PlaceObj("XTemplateWindow", {
                      "LayoutMethod",
                      ...
                      PlaceObj("XTemplateWindow", {
                        ...
                        true,
                        "Text",
                        T(655311941538, "<ButtonX> Select all / single")
                      }),
                      PlaceObj("XTemplateWindow", {
                        "comment",
                        "Y",
                        ...
                        true,
                        "Text",
                        T(570712236932, "<ButtonY> Command menu")
                      })
                    })
                  }),
                  PlaceObj("XTemplateWindow", {
...
<RSPress> Center camera]])
            ...
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                true,
                "Text",
                T(166317216542, "Additional Controls")
              }),
              PlaceObj("XTemplateWindow", {
                "VAlign",
                "top",
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  "Text",
                  T(263592825179, [[
<LeftTrigger><ButtonA> Overview mode
<LeftTrigger><ButtonB> Retreat]])
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  "Text",
                  T(101355868586, [[
<LeftTrigger><ButtonX> Character Screen
...
<RightTrigger><ButtonB> End Turn]])
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  "Text",
                  T(892108842732, [[
<RightTrigger><ButtonX> Hide/Reveal
<RightTrigger><ButtonY> Overwatch]])
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  "Text",
                  T(540295544985, [[
<RightTrigger><DPadUp> Previous merc info
<RightTrigger><DPadDown> Next merc info
          ...
          PlaceObj("XTemplateWindow", {
            ...
            "__condition",
            function(parent, context)
              return Game and gv_SatelliteView
            end,
            "__class",
            "XContentTemplate",
            "Margins",
            ...
            PlaceObj("XTemplateWindow", {
              ...
              true,
              "Text",
              T(475789913184, "Satellite view")
            }),
            PlaceObj("XTemplateWindow", {
              "comment",
              "Controller layout - satellite",
              "LayoutMethod",
              "VList"
            }, {
              PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  PlaceObj("XTemplateWindow", {
                    ...
                    true,
                    "Text",
                    T(441764927615, "<LeftTrigger> Additional controls"),
                    "TextHAlign",
                    "right"
                  }),
                  PlaceObj("XTemplateWindow", {
...
<DPadDown> Zoom out]])
                    ...
                    PlaceObj("XTemplateWindow", {
                      ...
                      "Text",
                      T(930080237721, [[
<LeftTrigger><DPadUp> Max zoom in
<LeftTrigger><DPadDown> Max zoom out]])
                ...
                PlaceObj("XTemplateWindow", {
                  ...
                  PlaceObj("XTemplateWindow", {
                    ...
                    true,
                    "Text",
                    T(621635151256, "<RightTrigger> Additional controls")
                  }),
                  PlaceObj("XTemplateWindow", {
                    "comment",
                    "RB",
                  ...
                  PlaceObj("XTemplateWindow", {
                    ...
                    PlaceObj("XTemplateWindow", {
                      ...
                      PlaceObj("XTemplateWindow", {
                        ...
                        true,
                        "Text",
                        T(463271958214, "<ButtonB> Close sector menu")
                      })
                    }),
                    PlaceObj("XTemplateWindow", {
                      "LayoutMethod",
                      ...
                      PlaceObj("XTemplateWindow", {
                        ...
                        true,
                        "Text",
                        T(333110685753, "<ButtonX> Sector menu")
                      }),
                      PlaceObj("XTemplateWindow", {
                        "comment",
                        "X - Additional",
                        ...
                        true,
                        "Text",
                        T(729282089606, "<LeftTrigger><ButtonX> Character screen")
                      }),
                      PlaceObj("XTemplateWindow", {
                        "comment",
                        "Y",
                        ...
                        true,
                        "Text",
                        T(184229816956, "<ButtonY> Command menu")
                      }),
                      PlaceObj("XTemplateWindow", {
                        "comment",
                        "Y - Additional",
                        ...
                        true,
                        "Text",
                        T(464630100135, "<LeftTrigger><ButtonY> Inventory")
                      })
                    })
                  }),
                  PlaceObj("XTemplateWindow", {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                    ...
                    PlaceObj("XTemplateFunc", {
                      ...
                      function(self, shortcut, source, ...)
                        if shortcut == "Escape" or shortcut == "Enter" or GetUIStyleGamepad() then
                          if not HasControllerTextInput() and shortcut == "-ButtonA" then
                            return "break"
                          end
                          self:OnKillFocus()
                          return "break"
                ...
                PlaceObj("XTemplateFunc", {
                  "name",
                  "OnSelection(self, focused_item, selection)",
                  "func",
        ...
        PlaceObj("XTemplateMode", {"mode", "options"}, {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateAction", {
              ...
              function(self, host, source, ...)
                local obj = ResolvePropObj(self.host:ResolveId("idScrollArea").context)
                obj:ResetOptionsByCategory(GetDialogModeParam(self.host).optObj.id, nil, IsInMultiplayerGame() and not NetIsHost() and {
                  Difficulty = true,
                  ForgivingModeToggle = true,
                  ActivePauseMode = true
                })
                ObjModified(obj)
            ...
            PlaceObj("XTemplateWindow", {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                PlaceObj("XTemplateTemplate", {
                  "__context",
                  function(parent, context)
                    return GameRuleDefs.ActivePause
                  end,
                  "__template",
                  "NewGameBoolEntry",
                  "IdNode",
                ...
                PlaceObj("XTemplateForEach", {
                  ...
                  function(child, context, item, i, n, last)
                    ...
                    if help_text then
                      ...
                      help_title = help_title or item.text
                    end
                    if help_title then
