        ...
        PlaceObj("XTemplateWindow", {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateWindow", nil, {
              ...
              PlaceObj("XTemplateWindow", {
                ...
                PlaceObj("XTemplateFunc", {
                  "name",
                  "OnSelection(self, _, selection)",
                  "func",
                  function(self, _, selection)
                    selection = selection and selection[1]
                    if not selection then
                      return
                    end
                    local selectedMercWnd = self[selection]
                    if not selectedMercWnd then
                      return
                    end
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateTemplate", {
              "__condition",
              function(parent, context)
                return not InitialConflictNotStarted() or not not gv_AIMBrowserEverClosed
              end,
              "__template",
              "PDAStartButton",
              "Margins",
