  ...
  PlaceObj("XTemplateWindow", {
    ...
    PlaceObj("XTemplateThread", {
      ...
      PlaceObj("XTemplateVoice", {
        ...
        500,
        "Text",
        T(993177753169, "Grand Chien still needs you")
      }),
      PlaceObj("XTemplateVoice", {
        "TimeBefore",
        16000,
        ...
        30000,
        "Text",
        T(992696528563, "Explore Grand Chien at your own pace in the full game.<newline><newline>Thanks for playing the demo version!")
      })
    })
  })
})
