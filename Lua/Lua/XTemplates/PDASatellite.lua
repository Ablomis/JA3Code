        ...
        PlaceObj("XTemplateWindow", {
          ...
          PlaceObj("XTemplateWindow", {
            ...
            PlaceObj("XTemplateWindow", {
              ...
              true,
              "Text",
              T(937883176892, "<ShortcutButton('', 'LeftTrigger-DPadUp')> Max Zoom In"),
              "WordWrap",
              false
            }),
            PlaceObj("XTemplateWindow", {
              ...
              true,
              "Text",
              T(365302771940, "<ShortcutButton('', 'LeftTrigger-DPadDown')> Max Zoom Out"),
              "WordWrap",
              false
            }),
            PlaceObj("XTemplateWindow", {
              ...
              true,
              "Text",
              T(779675776433, "<ShortcutButton('actionOpenCharacter')> Character Screen"),
              "WordWrap",
              false
            }),
            PlaceObj("XTemplateWindow", {
              ...
              true,
              "Text",
              T(386416906518, "<ShortcutButton('idInventory')> Inventory"),
              "WordWrap",
              false
            })
          })
