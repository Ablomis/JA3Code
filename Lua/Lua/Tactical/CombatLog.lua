...
function CombatLogMessageFader:UpdateLayout()
  ...
  if GetUIStyleGamepad() then
    local bottomBar, verticalOffset
    ...
    if bottomBar then
      ...
      self:SetBox(bbbbox:minx() + bbbbox:sizex() / 2 - self.measure_width / 2, bbbbox:miny() - self.measure_height - yMargin, self.measure_width, self.measure_height)
