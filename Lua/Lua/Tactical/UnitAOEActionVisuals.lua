...
function OverwatchVisuals:UpdateFromOverwatch(overwatch)
  ...
  local aoe_tiles_mesh, avgz = CreateAOETilesSector(step_positions, step_objs, los_values, self.aoe_tiles_mesh, overwatch.pos, overwatch.target_pos, overwatch.min_distance_2d or 1 * guim, overwatch.dist, overwatch.cone_angle)
