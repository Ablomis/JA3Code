...
DefineModItemPreset("Caliber", {
  EditorName = "Caliber mod",
  EditorSubmenu = "Item"
})
...
DefineClass.CombatAction = {
  ...
  properties = {
    ...
    },
    {
      ...
      default = false,
      no_edit = function(self)
        return self.ActivePauseBehavior ~= "queue"
      end,
      template = true,
      translate = true
    },
...
DefineModItemPreset("CraftOperationsRecipeDef", {
  EditorName = "Crafting operation recipe",
...
DefineModItemPreset("PopupNotification", {
  EditorName = "Popup notification",
...
DefineModItemPreset("RecipeDef", {
  EditorName = "Combine recipe",
  EditorSubmenu = "Item"
})
...
DefineModItemPreset("WeaponUpgradeSlot", {
  EditorName = "Weapon Slot",
  EditorSubmenu = "Item"
})
