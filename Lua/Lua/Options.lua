...
local game_properties = {
  ...
  },
  {
    ...
    default = false,
    storage = "account",
    no_edit = terminal.IsMouseEnabled(),
    help = T(344343486722, "Use left-click to move mercs while exploring a sector out of combat.")
  },
  {
    category = "Controls",
    id = "ShowGamepadHints",
    name = T(731273807036, "Control Hints"),
    editor = "bool",
    default = true,
    storage = "account",
    help = T(696057050384, "Shows control hints while in exploration and in combat.")
  },
  {
    category = "Gameplay",
    id = "Difficulty",
...
The action camera is always used with long-range weapons like sniper rifles.]])
  ...
  },
  {
    ...
    SortKey = -1600,
    help = T(983637939241, "Lowers the impact of attrition and makes it easier to recover from bad situations (faster healing and repair, better income).<newline><newline><flavor>You cannot unlock the \"Ironman\" achievement while Forgiving mode is enabled.</flavor><newline><newline><flavor>You can change this option at any time during gameplay.</flavor>")
  },
  {
    category = "Gameplay",
    id = "ActivePauseMode",
    name = T(133670189455, "Active Pause"),
    editor = "bool",
    default = true,
    storage = "local",
    no_edit = function(self)
    ...
    SortKey = -1590,
    help = T(466566359686, "Allows pausing the game in Exploration mode. Actions can be ordered while in pause but any attack will unpause the game.<newline><newline><flavor>You can change this option at any time during gameplay.</flavor>")
  },
  {
    category = "Display",
