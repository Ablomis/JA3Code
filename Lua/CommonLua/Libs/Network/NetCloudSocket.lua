...
function NetIsOfficialConnection()
  if not (NetIsConnected() and (not Platform.playstation or PSNAllowOfficialConnection) and (not Platform.xbox or XboxAllowOfficialConnection)) or Platform.switch and not NintendoAllowOfficialConnection then
    return
  end
