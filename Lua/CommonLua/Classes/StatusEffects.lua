...
DefineClass.StatusEffect = {
  ...
  properties = {
    ...
    },
    {
      ...
      id = "Incompatible",
      name = "Incompatible",
      help = "Defines mutually exclusive status effects that cannot coexist. A status effect cannot be added if there are exclusive ones already present. The relationship is symmetric.",
    ...
    {
      category = "Status Effect",
      id = "RemoveStatusEffects",
      name = "Remove",
      help = "Status effects to be removed when this one is added. A removed status effect cannot be added later if the current status effect is present, unless they are set to remove each other.",
      editor = "preset_id_list",
      default = {},
      preset_class = function(obj)
        return obj.class
