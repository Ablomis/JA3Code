...
Affects the diffuse contribution of the Sun.]]
    ...
    },
    {
      ...
      editor = "number",
      slider = true,
      help = "From what percentage of the luminance of the scene to consider."
    },
    {
      category = "Exposure",
      feature = "autoexposure",
      name = "AE Lum Max",
      id = "ae_brightness_ign",
      min = 1,
      max = 100,
      default = 95,
      scale = "%",
      editor = "number",
      slider = true,
      help = "Until what percentage of the luminance of the scene to consider."
    },
    {
      category = "Exposure",
      feature = "autoexposure",
  ...
  EarlyClassDescendants(classdefs, "LightmodelPart", function(class_name, classdef)
    ...
    local uses_preset = function(chain_func)
      return function(self, ...)
        ...
        if type(chain_func) == "function" then
...
function OnMsg.GedClosing(id)
  ...
  if app.app_template == "LightmodelEditor" then
    hr.AutoExposureMode = (EngineOptions.EyeAdaptation ~= "On" or not 1) and false
