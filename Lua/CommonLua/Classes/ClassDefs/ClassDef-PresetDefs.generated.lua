    ...
    properties = {
      {
        ...
        editor = "help",
        help = [[
Appends entries to a specific Loot definition. Clicking the test button will apply the change.
If more than one mod changes the same Loot definition, the one that has loaded last will decide the final value. Defining the dependency list for a mod will ensure the load order of given mods and allow for some control over this problem.]]
      },
      {
        id = "TargetClass"
      },
