...
function ForcedImpassableMarker:GetArea()
  if not self.area then
    if self:IsValidPos() then
      ...
      if 0 < sizez then
        self.area = box(posx - sizex / 2, posy - sizey / 2, posz - sizez / 2, posx + sizex / 2 + 1, posy + sizey / 2 + 1, posz + sizez / 2 + 1)
      else
        self.area = box(posx - sizex / 2, posy - sizey / 2, posx + sizex / 2 + 1, posy + sizey / 2 + 1)
      end
    else
      self.area = box()
    end
