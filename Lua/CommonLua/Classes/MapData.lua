...
DefineClass.MapDataPreset = {
  ...
  properties = {
    ...
    },
    {
      ...
      editor = "number",
      min = 1,
      max = const.MaxMapHeight or 6145,
      step = 128,
      slider = true,
      default = 257
    },
    {
      ...
      editor = "help",
      help = function(self)
        return string.format("Map size (meters): %dm x %dm", MulDivTrunc(self.Width - 1, const.HeightTileSize, guim), MulDivTrunc(self.Height - 1, const.HeightTileSize, guim))
      end
    },
    {
      category = "Base",
