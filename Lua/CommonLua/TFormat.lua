...
function TFormat.ImportButtonText()
  return T(933464437379, "Import Directory: <if(platform('ps4'))>[PROJECT]Assets/Build/[PLATFORM]/AppData/ExternalSaves/</if><if(platform('ps5'))>[PROJECT]Assets/Build/[PLATFORM]/ExternalSaves/</if><if(platform('xbox'))>[YOUR CONSOLE IP]/SystemScratch/ExternalSaves/</if>")
end
function TFormat.ExportButtonText()
  return T(896414591494, "Export Directory: <if(platform('ps4'))>[PROJECT]Assets/Build/[PLATFORM]/AppData/ExportedSaves/</if><if(platform('ps5'))>[YOUR CONSOLE IP]/devlog/app/[PROJECT]/AppData/ExportedSaves/</if><if(platform('xbox'))>[YOUR CONSOLE IP]/SystemScratch/ExportedSaves/</if>")
end
