...
if not config.DisableOptions then
  function OnMsg.Autorun()
    ...
    if Platform.pc then
      ...
      local is_intel = graphics_adapter.vendorId == const.VendorIds.Intel or string.find(gpu_name, "intel") or string.find(gpu_name, "arc")
    ...
    if taa_option.hr == empty_table then
      taa_option.text = T(392695272733, "Off")
    end
...
function Options.Autodetect(options)
  if (Platform.pc or Platform.steamdeck) and not IsPoint(options.Resolution) then
...
OptionsData.Options.VideoPreset = {
  {
    value = "Low",
    text = T(644, "Low"),
    not_selectable = Platform.console
  },
  {
    value = "Medium",
    text = T(645, "Medium"),
  ...
  {
    value = "XboxOneXQuality",
    text = T({"Quality"}),
    not_selectable = not Platform.xbox_one_x
  },
  {
    value = "XboxOneXPerformance",
    text = T({
      "Performance"
    }),
    not_selectable = not Platform.xbox_one_x
  ...
  {
    value = "XboxSeriesSQuality",
    text = T({"Quality"}),
    not_selectable = not Platform.xbox_series_s
  },
  {
    value = "XboxSeriesSPerformance",
    text = T({
      "Performance"
    }),
    not_selectable = not Platform.xbox_series_s
  ...
  {
    value = "XboxSeriesXQuality",
    text = T({"Quality"}),
    not_selectable = not Platform.xbox_series_x
  },
  {
    value = "XboxSeriesXPerformance",
    text = T({
      "Performance"
    }),
    not_selectable = not Platform.xbox_series_x
...
local ResolveAntialiasingOption = function(antialiasing)
...
local NotSelectableTemporalUpscalingOption = function(self, options_obj)
...
OptionsData.Options.Upscaling = {
  {
    ...
    hr = {ResolutionUpscale = "none"},
    not_selectable = true
  },
  {
    value = "DLSS",
    text = Untranslated("NVIDIA DLSS 2"),
    not_selectable = NotSelectableTemporalUpscalingOption,
  ...
  {
    value = "FSR",
    text = Untranslated("AMD FSR 1.0"),
    hr = {ResolutionUpscale = "fsr"},
    not_selectable = function(self, options_obj)
      return IsTemporalAntialiasingOption(options_obj.Antialiasing)
    end,
...
OptionsData.Options.ResolutionPercent = {
  {
    ...
    not_selectable = function(self, options_obj)
      return options_obj.Antialiasing == "XESS"
    end
  },
  {
    value = "77",
  ...
  },
  {
    ...
    not_selectable = function(self, options_obj)
      return not IsTemporalAntialiasingOption(options_obj.Antialiasing) or options_obj.Antialiasing == "XESS"
    end
  }
}
OptionsData.Options.Antialiasing = {
  ...
  {
    value = "TAA",
    text = Untranslated("TAA"),
    hr = empty_table,
    not_selectable = function(self)
      return self.hr == empty_table
    end,
  ...
  },
  {
    ...
    text = T({
      ...
      "<name>",
      name = function()
        return Untranslated(OptionsObj and OptionsObj.ResolutionPercent == "100" and "NVIDIA DLAA 2" or "NVIDIA DLSS 2")
      end
    }),
    hr = {ResolutionUpscale = "dlss"},
    not_selectable = function(self)
      return not hr.TemporalIsTypeSupported(self.hr.ResolutionUpscale)
    end,
...
OptionsCategories = {
  ...
  },
  {
    ...
    no_edit = (Platform.ps4 or Platform.xbox_one) and Platform.goldmaster
  },
  {
    id = "Audio",
