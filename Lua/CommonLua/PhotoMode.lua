...
DefineClass.PhotoModeObject = {
  ...
  properties = {
    ...
    },
    {
      ...
      no_edit = not not config.PhotoMode_DisablePhotoFilter
    },
    {
    ...
    {
      name = T(778534179054, "Saturation"),
      id = "colorSat",
      editor = "number",
      slider = true,
      default = 0,
    ...
    },
    {
      ...
      id = "fov",
      editor = "number",
      default = const.DefaultCameraRTS and const.DefaultCameraRTS.FovX or 5400,
      slider = true,
      min = 1200,
      max = 7200,
      scale = 60,
      step = function()
        return PhotoModeGetPropStep(300, 1)
      end,
      dpad_only = true
    }
  }
