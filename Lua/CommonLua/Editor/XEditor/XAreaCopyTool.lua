...
function XAreaCopyTool:CreateBrushGrid()
  ...
  self.Grid = NewHierarchicalGrid(width, height, 64, 1)
  return self.Grid
end
...
function XTerrainGridData:CaptureData(bbox, mask_grid, mask_grid_tile_size)
  for _, grid in ipairs(editor.GetGridNames()) do
    local copied_area, mask_area = editor.GetGrid(grid, bbox, mask_grid or nil, mask_grid_tile_size or nil)
